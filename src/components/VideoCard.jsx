...
const VideoCard = ({displayData,setdeleteVideoRespone,insideCateogry}) => {
  ...
  return (
    ...
    <Modal size='lg' centered show={show} onHide={handleClose}>
        ...
        <Modal.Body>
        <iframe width="100%" height="369" src={`${displayData?.link}?autoplay=1`} title="caption"  allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen></iframe>
        </Modal.Body>
