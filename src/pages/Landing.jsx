...
const Landing = () => {
  ...
  <div style={{padding:'80px'}} className='container'>
      <div className="row align-items-center">
        ...
        <div className="col-lg-6">
          <img className='img-fluid ms-5' src="https://media.giphy.com/media/9LIfhJGb3JeXm/giphy.gif" alt="" />
        </div>
      </div>
      <div className="my-5">
      ...
      <Card.Body>
        ...
        <Card.Text>
          ...
          <div className="col-lg-4">
          <Card style={{ width: '18rem' }}>
      <Card.Img height={'250px'} variant="top" src="https://www.clayton.edu/_resources/images/manage-account.svg" />
      <Card.Body>
 ...
 <div className="my-5 row align-items-center border rounded p-5">
  <div className="col-lg-5">
    ...
    <p style={{textAlign:'justify'}}> <span className='fs-5'>Cateogrise Videos</span> <br />
    Lorem ipsum dolor sit amet consectetur adipisicing elit. Consequatur quo libero ut? Illo, labore? Dolor adipisci architecto et odio, laudantium necessitatibus unde reprehenderit ea hic sequi perferendis magni aut qui!
    </p>
    <p style={{textAlign:'justify'}}> <span className='fs-5'>Managing History</span> <br />
    Lorem ipsum dolor sit amet consectetur adipisicing elit. Consequatur quo libero ut? Illo, labore? Dolor adipisci architecto et odio, laudantium necessitatibus unde reprehenderit ea hic sequi perferendis magni aut qui!
    </p>
  </div>
  <div className="col"></div>
